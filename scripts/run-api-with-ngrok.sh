...
export STRIPE_PRICE_CREDITS_ID=$(grep "^STRIPE_PRICE_CREDITS_ID=" .env | cut -d= -f2-)
export STRIPE_CREDIT_METER_EVENT_NAME=$(grep "^STRIPE_CREDIT_METER_EVENT_NAME=" .env | cut -d= -f2-)
export STRIPE_CREDIT_METER_CUSTOMER_KEY=$(grep "^STRIPE_CREDIT_METER_CUSTOMER_KEY=" .env | cut -d= -f2-)
export STRIPE_CREDIT_METER_VALUE_KEY=$(grep "^STRIPE_CREDIT_METER_VALUE_KEY=" .env | cut -d= -f2-)
export FREE_TRIAL_CREDIT_USD=$(grep "^FREE_TRIAL_CREDIT_USD=" .env | cut -d= -f2-)
