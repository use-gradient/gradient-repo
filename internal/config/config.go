...
type Config struct {
	...
	StripePriceCreditsID         string
	StripeCreditMeterEventName   string
	StripeCreditMeterCustomerKey string
	StripeCreditMeterValueKey    string
...
func Load() *Config {
	return &Config{
		...
		StripePriceCreditsID:         getEnv("STRIPE_PRICE_CREDITS_ID", ""),
		StripeCreditMeterEventName:   getEnv("STRIPE_CREDIT_METER_EVENT_NAME", "gradient_credits"),
		StripeCreditMeterCustomerKey: getEnv("STRIPE_CREDIT_METER_CUSTOMER_KEY", "stripe_customer_id"),
		StripeCreditMeterValueKey:    getEnv("STRIPE_CREDIT_METER_VALUE_KEY", "credits"),
		FreeTrialCreditUSD:           getEnvFloat("FREE_TRIAL_CREDIT_USD", 10.0),
